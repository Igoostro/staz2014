            ...
            <tbody>
                ...
                while ($row1 = pg_fetch_row($result1)){
                    ...
                    while ($row2 = pg_fetch_row($result2)){
                        ...
                        echo "<tr><td>$row1[0]</td><td>$row1[1]</td><td>$row2[0]</td><td class='numbers'>$row1[2]</td><td class='numbers'>$offLanUsePer</td><td class='numbers'>$offLanPopUse</td><td id='details'><a href='country?code=$sendCode'>Details</a></td></tr>";
                    }
                }
